    ...
    <div className="screen active">
      ...
      <div className="account-section">
        <div className="account-menu">
          <Link to="/edit-profile" className="account-menu-item">
          ...
          <Link to="/investors" className="account-menu-item">
          ...
          <Link to="/payment-methods" className="account-menu-item">
          ...
          <Link to="/safety" className="account-menu-item">
      ...
      <div className="account-version">RideGo v1.0 — Oslo</div>
    </div>
  );
}
